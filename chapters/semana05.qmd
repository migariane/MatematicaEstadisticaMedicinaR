...
### El Problema del Sesgo de Muestreo: El Caso del Literary Digest (1936)

La importancia de un muestreo adecuado se ilustra con uno de los mayores fracasos en la historia de las encuestas:

::: {.callout-warning}
## Advertencia: El Ejemplo del Literary Digest
En la elección presidencial de EE.UU. de 1936:

- La revista **The Literary Digest** encuestó a **10 millones de personas** (seleccionadas de propietarios de teléfono y coche, y suscriptores de la revista)
- Recibieron 2.3 millones de respuestas
- **Predicción**: 60% republicanos, 40% demócratas
- **Resultado real**: 36.5% republicanos, 60.8% demócratas
- **Gallup Institute**, con solo 50,000 encuestados aleatorios, predijo correctamente

**Lección**: Un número grande de respuestas NO garantiza una muestra sin sesgo. El sesgo de selección (muestra no representativa) es más importante que el tamaño.
:::
...
## Ejemplo 5.1: Simulando el Teorema Central del Límite {#sec-semana05-s9}

::: {.callout-tip}
## Ejemplo 5.2: TCL con Variables Exponenciales
...
::: {.callout-tip}
## Ejemplo: Distribuciones Muestrales de la Media
...
curve(dnorm(x, mean = 100, sd = 15/sqrt(n)),
      ...
      label = "Teórica: N(100, 15/sqrt(30))")
...
**Ejercicio 5.1:**  
- (a) $\text{Var}(\bar{X}) = \frac{200^2}{100} \cdot \frac{5000-100}{5000-1} \approx 388$ (con CPF)  
- (b) $\sigma(\bar{X}) = \sqrt{388} \approx 19.7$ horas  
- (c) Con $n=400$: $\sigma(\bar{X}) \approx 9.8$ horas  
- (d) Aumentar $n$ reduce el error estándar proporcionalmente a $1/\sqrt{n}$  
...
- (c) IC: $0.54 \pm 1.96 \times 0.0204 \approx [0.499, 0.581]$  
