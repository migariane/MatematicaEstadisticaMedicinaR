...
$$\text{Primero: } \bar{x} = 3.1, \quad \bar{y} \approx 5.05$$

$$s_x \approx 1.150, \quad s_y \approx 1.235$$

$$\text{Covarianza: } \text{Cov}(X,Y) = \frac{\sum(x_i - \bar{x})(y_i - \bar{y})}{n-1} \approx 1.411$$

$$r = \frac{\text{Cov}(X,Y)}{s_x s_y} = \frac{1.411}{1.150 \times 1.235} \approx 0.994$$

**b) Interpretación:** Existe una correlación positiva casi perfecta (r ≈ 0.994) entre horas de estudio y nota del examen. A mayor número de horas, mayor calificación. Aproximadamente 98.8% (r²) de la variación en notas se explica por las horas de estudio.

**c) Valores atípicos:** La relación es fuertemente lineal con un único punto (1.5 h, nota 3) que se desvía ligeramente de la tendencia y = x + 2 del resto de pares; la correlación casi perfecta sugiere que este desvío es pequeño y no hay evidencia de outliers importantes.
</div>
...
- $\bar{x} = 101.25$, $\bar{y} = 186.25$
- $S_{xx} = \sum(x_i - \bar{x})^2 = 2137.5$
- $S_{xy} = \sum(x_i - \bar{x})(y_i - \bar{y}) = 3162.5$

Coeficiente de regresión:
$$\hat{\beta}_1 = \frac{S_{xy}}{S_{xx}} = \frac{3162.5}{2137.5} \approx 1.480$$

Ordenada en el origen:
$$\hat{\beta}_0 = \bar{y} - \hat{\beta}_1\bar{x} = 186.25 - 1.480 \times 101.25 \approx 36.45$$

**Modelo estimado:**
$$\hat{Y} = 36.45 + 1.480 X$$

**b) Interpretación de coeficientes:**
- $\hat{\beta}_0 = 36.45$: Es el precio base teórico (no tiene interpretación práctica directa para $X=0$)
- $\hat{\beta}_1 = 1.480$: Por cada m² adicional, el precio aumenta aproximadamente 1.480 mil euros (1480 €/m²)

**c) Coeficiente de determinación R²:**

$$S_{yy} = \sum(y_i - \bar{y})^2 = 4737.5$$

$$R^2 = \frac{(S_{xy})^2}{S_{xx} \times S_{yy}} = \frac{(3162.5)^2}{2137.5 \times 4737.5} \approx \frac{10.00 \times 10^6}{10.13 \times 10^6} \approx 0.9876$$

Interpretación: El 98.8% de la variabilidad en los precios se explica por el tamaño de la vivienda. El ajuste es excelente.

**d) Predicción para X = 105 m²:**

$$\hat{Y}(105) = 36.45 + 1.480 \times 105 = 36.45 + 155.40 \approx 191.85 \text{ k€}$$

Precio predicho: aproximadamente **191,850 €** para una vivienda de 105 m².
</div>
