...
```{r}
#| lst-label: lst-apendiceB-icl-retin
#| lst-cap: "icl() — IC exacto para una tasa de incidencia"
#| warning: false
#| message: false
icl(x = 12, n = 1000)
```
...
```{r}
#| lst-label: lst-apendiceB-nl-pilot
#| lst-cap: "nl() — tamaño muestral a partir de observación piloto"
#| warning: false
#| message: false
nl(x = 3, d = 1)
```
...
```{r}
#| lst-label: lst-apendiceB-nl-lmax
#| lst-cap: "nl() — tamaño muestral a partir de un valor máximo esperado"
#| warning: false
#| message: false
nl(lmax = 4.5, d = 1)
```
...
::: {.callout-tip}
## Ejemplo B.15: HbA1c \~ tevol + edad + IMC
...
::: {.callout-tip}
## Ejemplo B.19: Osteoporosis por grupo de edad (tabla 3×2)
