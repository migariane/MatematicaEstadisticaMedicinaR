...
::: {.callout-tip}
## Ejercicio 10.1: Interpretación de Coeficientes Parciales

En un modelo para la **hemoglobina glicosilada** (HbA1c, %) se incluyen los años de evolución de la diabetes, la edad y el IMC. El coeficiente estimado de los años de evolución es 0.05 y el coeficiente del IMC se denota por $b_{\text{IMC}}$.

(a) Interprete el coeficiente de los años de evolución.
(b) Interprete de forma general el coeficiente $b_{\text{IMC}}$.
:::

::: {.callout-tip}
## Ejercicio 10.2: Matriz de Diseño y Grados de Libertad

Un estudio epidemiológico analiza la **presión arterial diastólica** mediante tres variables predictoras: edad, IMC y tabaquismo en paquetes-año. Se dispone de 80 observaciones y el modelo incluye intercepto.

(a) ¿Cuál es la dimensión de la matriz $\mathbf{X}$?
(b) ¿Qué contiene su primera columna?
(c) ¿Cuántos grados de libertad tienen los residuos si la matriz tiene rango completo?
:::

::: {.callout-tip}
## Ejercicio 10.3: Multicolinealidad

En un modelo de riesgo cardiovascular se incluyen simultáneamente el colesterol LDL y el colesterol no-HDL, ambos medidos en mg/dL.

(a) Explique por qué podría aparecer multicolinealidad y qué consecuencias tendría.
(b) ¿Cómo se evaluaría mediante el VIF?
(c) ¿Qué alternativas podrían considerarse si la multicolinealidad fuese elevada?
:::

::: {.callout-tip}
## Ejercicio 10.4: Selección y Comparación de Modelos

En un modelo lineal para una respuesta clínica continua en cáncer de mama se incorporan secuencialmente 15 variables predictoras.

(a) ¿Por qué $R^2$ no puede disminuir al añadir predictores al modelo?
(b) Compare AIC, BIC y $R^2_{\text{adj}}$ según el objetivo del análisis. ¿Qué comprobación adicional requiere un modelo destinado a predicción?
:::

::: {.callout-tip}
## Ejercicio 10.5: Prueba F para Modelos Anidados

En un estudio de HbA1c se ajustan, sobre los mismos 94 pacientes, los siguientes modelos:
...
Se obtiene $\text{RSS}_A=188.4$ y $\text{RSS}_B=172.6$. Suponga satisfechos los supuestos necesarios para la prueba F.

(a) Formule la hipótesis nula del contraste.
(b) Calcule el estadístico F.
(c) Con $F_{0.95;2,90}\approx3.10$, tome una decisión con $\alpha=0.05$ e interprete el resultado.
:::

::: {.callout-tip}
## Ejercicio 10.6: Variables Indicadoras

En un ensayo clínico de cuatro brazos se comparan metformina, sitagliptina y empagliflozina frente a placebo. Se utiliza codificación de tratamiento con placebo como referencia. El coeficiente estimado de empagliflozina es $-0.72$ puntos porcentuales de HbA1c, con $p=0.003$.

(a) ¿Cuántas variables indicadoras se necesitan y cuál es la categoría de referencia?
(b) Interprete el coeficiente de empagliflozina y su p-valor.
(c) ¿Permite esta información concluir que la diferencia es clínicamente relevante? Justifique brevemente.
:::
...
(a) Manteniendo constantes la edad y el IMC, cada año adicional de evolución se asocia con un aumento promedio de 0.05 puntos porcentuales en la HbA1c.
(b) Cada kg/m² adicional de IMC se asocia con un cambio promedio de $b_{\text{IMC}}$ puntos porcentuales en la HbA1c, ajustando por edad y años de evolución; el signo determina la dirección de la asociación.

**Ejercicio 10.2:**

(a) La matriz $\mathbf{X}$ tiene dimensión $80\times4$.
(b) La primera columna contiene unos y corresponde al intercepto.
(c) Los residuos tienen 76 grados de libertad.

**Ejercicio 10.3:**

(a) LDL y no-HDL comparten información, por lo que una correlación alta puede inflar los errores estándar y volver inestables los coeficientes; no constituyen necesariamente una dependencia lineal exacta.
(b) Deben calcularse los VIF en los datos; valores elevados indicarían un problema de multicolinealidad.
(c) Puede preespecificarse uno de los indicadores según el objetivo, comparar modelos alternativos o considerar regularización si el propósito es predictivo.

**Ejercicio 10.4:**

(a) Al añadir predictores, el RSS no puede aumentar; por tanto, $R^2$ aumenta o permanece igual.
(b) AIC se orienta más a predicción relativa, BIC favorece modelos parsimoniosos y confirmatorios, y $R^2_{\text{adj}}$ resume el ajuste penalizado. Un modelo predictivo debe evaluarse fuera de la muestra de ajuste.

**Ejercicio 10.5:**

(a) $H_0:\beta_2=\beta_3=0$ frente a que al menos uno de estos coeficientes sea distinto de cero.
(b) $F\approx4.12$, con 2 y 90 grados de libertad.
(c) Como $4.12>3.10$ ($p\approx0.019$), se rechaza $H_0$; al menos uno de los predictores añadidos aporta información adicional sobre la HbA1c más allá del tiempo de evolución.

**Ejercicio 10.6:**

(a) Se necesitan tres variables indicadoras y placebo es la categoría de referencia.
(b) La HbA1c media estimada con empagliflozina es 0.72 puntos porcentuales menor que con placebo; la diferencia es estadísticamente significativa ($p=0.003$).
(c) No. La relevancia clínica requiere un umbral preespecificado, un intervalo de confianza y una valoración conjunta de beneficios y seguridad.
