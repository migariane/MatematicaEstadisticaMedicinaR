...
::: {.callout-tip}
## Ejemplo 2.1: BioestadisticaR2 grps()
...
Aunque paquetes como `BioestadisticaR2` son potentes, es fundamental saber usar las funciones básicas de R para un análisis rápido.
