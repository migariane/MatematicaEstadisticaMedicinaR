...
```{r}
#| label: lst-s12-bio01
#| lst-cap: "BioStatR — tabla2x2(): tabaquismo y osteoporosis"
#| warning: false
#| message: false
#| echo: false
...
```{r}
#| label: lst-s12-bio02
#| lst-cap: "BioStatR — tablarxc(): homogeneidad entre 3 grupos de tratamiento"
#| warning: false
#| message: false
#| echo: false
...
### Implementación: BioStatR vs. Base R

::: {.callout-tip}
## BioStatR — testmcnemar(): Datos apareados

Para datos apareados (donde las observaciones son dependientes), utilizamos la función `testmcnemar()` del paquete `BioStatR`.

```{r}
#| label: lst-s12-bio03
#| lst-cap: "BioStatR: Test de McNemar para datos apareados"
#| eval: true
...
- `tabla2x2()` de BioStatR calcula OR e IC directamente
:::
...
```{r}
#| label: lst-s12-bio04
#| lst-cap: "BioStatR — tabla2x2(): caso-control, OR con IC"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-bio05
#| lst-cap: "BioStatR — testnormal() y Base R — shapiro.test()"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-r05
#| lst-cap: "Comparación BioStatR vs. Base R — Chi-cuadrado en tabla 2×2"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-r06
#| lst-cap: "Comparación BioStatR vs. Base R — Test de McNemar"
#| eval: true
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-bio06
#| lst-cap: "BioStatR — tablarxc(): grupos de edad y tabaquismo"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-bio07
#| lst-cap: "BioStatR — Análisis completo: osteo dataset UGR"
#| warning: false
#| message: false
...
#| lst-cap: "BioStatR — rlogitm(): regresión logística múltiple sobre el dataset osteo"
#| warning: false
#| message: false
#| fig-width: 6
#| fig-height: 5
