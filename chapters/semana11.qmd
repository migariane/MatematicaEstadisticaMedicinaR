...
Analizamos la asociación entre tabaquismo (`tabaco`) y osteoporosis del cuello femoral (`osteo_cue`) en 94 pacientes diabéticos. Documentación completa en @sec-bio-tablas.
...
# (ver @sec-semana11-mcnemar para la salida completa; requiere BioEstatR)
