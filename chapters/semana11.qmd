...
::: {.callout-tip}
## Ejercicio 11.1: Chi-cuadrado de Independencia
...
(a) Calcule las frecuencias esperadas bajo la hipótesis de independencia.
(b) Calcule manualmente el estadístico de Pearson $\chi^2$.
(c) Con $\alpha=0.05$, tome una decisión e interprete el resultado.
:::

::: {.callout-tip}
## Ejercicio 11.2: Chi-cuadrado de Homogeneidad
...
::: {.callout-tip}
## Ejercicio 11.3: Frecuencias Esperadas y Elección de la Prueba
...
(a) Calcule las frecuencias esperadas y compruebe la condición clásica para aplicar la aproximación $\chi^2$.
(b) Según la recomendación del capítulo para este tamaño muestral, indique qué versión de la prueba conviene utilizar.
(c) Aplique la prueba seleccionada e interprete el resultado con $\alpha=0.05$.
:::

::: {.callout-tip}
## Ejercicio 11.4: Prueba de McNemar
...
(a) ¿Por qué no corresponde aplicar la prueba $\chi^2$ de independencia?
(b) Identifique los pares discordantes $b$ y $c$, e indique su total.
(c) Calcule el estadístico de McNemar con y sin corrección de continuidad.
(d) Con $\alpha=0.05$, determine si las tasas de positividad difieren e indique cuál prueba produjo más resultados positivos.
:::

::: {.callout-tip}
## Ejercicio 11.5: Riesgo Relativo y Diferencia de Riesgos
...
(b) Calcule su intervalo de confianza al 95%.
(c) Calcule la diferencia de riesgos y su inversa. ¿Bajo qué condición podría interpretarse esta última como número necesario para perjudicar?
:::

::: {.callout-tip}
## Ejercicio 11.6: Odds Ratio en un Estudio Caso-Control
...
(a) Construya la tabla 2×2.
(b) Calcule el odds ratio.
(c) Calcule el intervalo de confianza al 95% del odds ratio.
(d) Explique por qué no es adecuado calcular directamente el riesgo relativo en este diseño.
:::

::: {.callout-tip}
## Ejercicio 11.7: Razón de Prevalencias y Odds Ratio
...
(a) Calcule la razón de prevalencias.
(b) Calcule el odds ratio.
(c) Indique cuál de las dos medidas compara más directamente las prevalencias observadas.
(d) Compare los resultados y explique por qué no coinciden.
:::
...
(a) Las frecuencias esperadas son $32.5$, $117.5$, $32.5$ y $117.5$.
(b) $\chi^2\approx12.27$, con 1 grado de libertad y $p\approx0.00046$.
(c) Se rechaza la hipótesis de independencia; hay evidencia de asociación entre el consumo habitual de alcohol y la diabetes tipo 2.
...
(a) Las frecuencias esperadas son $5.5$, $9.5$, $5.5$ y $9.5$; todas cumplen la condición clásica $E_{ij}\geq5$.
(b) Para $n=30$, la recomendación del capítulo conduce a la prueba $\chi^2$ con corrección de Yates. Fisher bilateral también es posible, pero no resulta exigido por las frecuencias esperadas.
(c) $\chi^2_{\text{Yates}}\approx2.30$ y $p\approx0.130$; no se rechaza la hipótesis de independencia.

**Ejercicio 11.4:**

(a) Las dos mediciones proceden de los mismos pacientes y, por tanto, están apareadas.
(b) $b=12$, $c=5$ y $b+c=17$.
(c) Sin corrección, $\chi^2\approx2.88$ y $p\approx0.090$; con corrección, $\chi^2\approx2.12$ y $p\approx0.146$.
(d) No se rechaza la igualdad de las tasas de positividad. TAU produjo 50 resultados positivos y SERO 43; esta comparación no permite establecer cuál prueba tiene mayor sensibilidad.

**Ejercicio 11.5:**

(a) $RR=3.0$; el grupo expuesto presenta tres veces el riesgo de enfermedad pulmonar durante los cinco años de seguimiento.
(b) $SE_{\ln(RR)}\approx0.2543$ e $IC_{95\%}(RR)\approx[1.82,4.94]$.
(c) $RD=0.040$ y $1/RD=25$. Este último valor puede interpretarse como NNH únicamente si la diferencia de riesgos es atribuible causalmente a la exposición.

**Ejercicio 11.6:**

(a) Casos: 120 con hipertensión y 80 sin hipertensión; controles: 80 con hipertensión y 120 sin hipertensión.
(b) $OR=2.25$.
(c) $SE_{\ln(OR)}\approx0.2041$ e $IC_{95\%}(OR)\approx[1.51,3.36]$.
(d) El muestreo fija el número de casos y controles, por lo que no permite estimar directamente los riesgos de enfermedad ni su cociente.

**Ejercicio 11.7:**

(a) Las prevalencias son 30% y 6.67%; por tanto, $RP=4.5$.
(b) $OR=6.0$.
(c) La RP compara directamente las prevalencias; el OR compara las odds de prevalencia y no es intercambiable con la RP.
(d) No coinciden porque comparan magnitudes distintas. Con una prevalencia del 30% en el grupo con obesidad, el OR queda numéricamente más alejado de 1 que la RP.
