...
```{r}
#| label: lst-s12-bio01
#| lst-cap: "BioestadisticaR2 — tabla2x2(): tabaquismo y osteoporosis"
#| warning: false
#| message: false
#| echo: false
...
```{r}
#| label: lst-s12-bio02
#| lst-cap: "BioestadisticaR2 — tablarxc(): homogeneidad entre 3 grupos de tratamiento"
#| warning: false
#| message: false
#| echo: false
...
### Implementación: BioestadisticaR2 vs. Base R

::: {.callout-tip}
## BioestadisticaR2 — testmcnemar(): Datos apareados

Para datos apareados (donde las observaciones son dependientes), utilizamos la función `testmcnemar()` del paquete `BioestadisticaR2`.

```{r}
#| label: lst-s12-bio03
#| lst-cap: "BioestadisticaR2: Test de McNemar para datos apareados"
#| eval: true
...
- `tabla2x2()` de BioestadisticaR2 calcula OR e IC directamente
:::
...
```{r}
#| label: lst-s12-bio04
#| lst-cap: "BioestadisticaR2 — tabla2x2(): caso-control, OR con IC"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-bio05
#| lst-cap: "BioestadisticaR2 — testnormal() y Base R — shapiro.test()"
#| warning: false
#| message: false

library(BioestadisticaR2)

# Con BioestadisticaR2 (reporte completo con histograma)
...
```{r}
#| label: lst-s12-r05
#| lst-cap: "Comparación BioestadisticaR2 vs. Base R — Chi-cuadrado en tabla 2×2"
#| warning: false
#| message: false

# Con BioestadisticaR2 (tabla 2x2, Chi-cuadrado + OR + Fisher integrado)
tabla2x2(o11 = 44, o12 = 9, o21 = 26, o22 = 15,
         fcat = c("No fumador", "Fumador"),
         ccat = c("Sin osteoporosis", "Con osteoporosis"))
...
```{r}
#| label: lst-s12-r06
#| lst-cap: "Comparación BioestadisticaR2 vs. Base R — Test de McNemar"
#| eval: true
#| warning: false
#| message: false
...
# BioestadisticaR2: tabla2x2(..., estudio = "AP")
# (ver sección 12.5.5 para la salida completa; requiere BioestadisticaR2)
...
```{r}
#| label: lst-s12-bio06
#| lst-cap: "BioestadisticaR2 — tablarxc(): grupos de edad y tabaquismo"
#| warning: false
#| message: false
...
```{r}
#| label: lst-s12-bio07
#| lst-cap: "BioestadisticaR2 — Análisis completo: osteo dataset UGR"
#| warning: false
#| message: false
