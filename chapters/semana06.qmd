...
::: {.callout-tip}
## Ejemplo con BioStatR: icm() e icp()
...
Antes de iniciar un estudio clínico es esencial determinar el **tamaño muestral** necesario para alcanzar una precisión deseada en los intervalos de confianza. Las funciones `nm()` y `np()` del paquete `BioStatR` (ver @sec-bio-n) calculan el tamaño muestral requerido para una **media** o una **proporción**, respectivamente, dada una semiamplitud objetivo $d$ del IC.
