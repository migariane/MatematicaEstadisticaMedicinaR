...
*   **BioStatR:** Paquete de R desarrollado en la Unidad de Bioestadística de la Facultad de Medicina de la Universidad de Granada por **Pedro Femia Marzo** y **Miguel Ángel Luque Fernández**. Proporciona funciones de alto nivel que integran descripción, inferencia, modelización (lineal y logística) y visualización en una sola llamada, diseñadas específicamente para la docencia de bioestadística en ciencias de la salud. El paquete incluye también el conjunto de datos `osteo` (94 pacientes diabéticos, 27 variables), utilizado como hilo conductor de los ejemplos del libro.
...
# Instala BioStatR directamente desde GitHub (compila para tu sistema)
